...
export const tree: SitemapNode[] = [
  ...
  },
  {
    ...
    sources: ["home"],
    area: "blog",
    note: "Sección Rethink (en el home, built). Por ahora los posts enlazan a esic.co; el blog propio llega en la fase CMS.",
    children: [
      {
        ...
        sources: ["blog"],
        area: "blog",
        note: "Enlace externo a esic.co (pendiente migrar a CMS).",
      },
      {
  ...
  },
  {
    ...
    href: "/contacto/",
    status: "built",
    sources: ["footer", "cta", "home"],
    area: "institucional",
    note: "Formulario Zoho real (SolicitarInformacinFormulariogeneral110226) con dropdowns condicionales + UTM. Destino de los CTA 'Solicitar Información' y del 'Contáctanos' del footer.",
  },
  {
    label: "Footer · Legal",
    status: "built",
    sources: ["footer"],
    area: "legal",
    note: "Footer global montado en el Layout (todas las páginas salvo /dev).",
    children: [
      {
        ...
        sources: ["footer"],
        area: "legal",
        note: "Texto migrado de esic.co. Validar con documento oficial PRISMA.",
      },
      {
        ...
        sources: ["footer"],
        area: "legal",
        note: "Texto migrado de esic.co (Ley 1581/2012, Decreto 1377/2013).",
      },
    ],
  },
  {
